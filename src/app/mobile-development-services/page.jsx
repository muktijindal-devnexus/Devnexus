...
export const metadata = {
  title: "Mobile App Development Company - DevNexus Solutions",
  description:
    "Transform your Idea into apps. Get Mobile App development services at DevNexus. User-friendly, scalable, and tailored to your business goals. Visit us now.",
  alternates: {
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "At DevNexus Solutions, we are developing a wide range of mobile applications which are tailored to your business needs. Our expertise includes native app development, cross-functional app development, progressive web app development, e-commerce web app development.",
        },
      },
      {
        "@type": "Question",
