...
const StatusCard = () => {
  ...
  useEffect(() => {
    if (inView) {
      setCountKey(prev => prev + 1); // This triggers re-mount of CountUp
    }
  }, [inView]);
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-white px-6 py-6 md:px-10 md:py-6 rounded-xl shadow-md border border-blue-200 w-full max-w-4xl">
        ...
        <div className="flex flex-col items-center text-center px-4 mb-4 md:mb-0">
          ...
          <h3 className="text-lg md:text-xl font-bold">
            <CountUp key={`satisfaction-${countKey}`} end={96} duration={2} suffix="%" />
          </h3>
        ...
        <div className="flex flex-col items-center text-center px-4 mb-4 md:mb-0">
          ...
          <h3 className="text-lg md:text-xl font-bold">
            <CountUp key={`business-${countKey}`} end={10} duration={2} suffix="+" />
          </h3>
        ...
        <div className="flex flex-col items-center text-center px-4">
          ...
          <h3 className="text-lg md:text-xl font-bold">
            <CountUp key={`clients-${countKey}`} end={1200} duration={2.5} suffix="+" />
          </h3>
