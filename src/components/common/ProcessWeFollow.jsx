      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {steps.map((step, index) => (
            <div
              key={index}
              className="relative flex flex-col items-center border rounded-md shadow-md px-4 py-6 min-h-[300px] w-[120px] bg-white border-blue-200 
              transition-all duration-300 group hover:bg-[#335D95] hover:text-white hover:w-[260px] hover:z-10"
            >
              {/* Before hover view */}
              <div className="flex flex-col items-center h-full group-hover:hidden">
                <div className="text-[#00357A] font-bold text-lg">{`0${index + 1}`}</div>
              ...
              {/* Hover view */}
              <div className="hidden group-hover:flex flex-col items-start justify-start text-left h-full w-full">
