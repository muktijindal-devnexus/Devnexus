...
const caseStudies = [
  {
    ...
    logoSrc: "/cdn/images/cervinologo.svg",
    imageIcons: ["/brick-icon.png", "/code-icon.png"],
    mainImage: "/cdn/images/cervinoportfolio.png",
    websiteUrl: "https://cervinoceramix.com",
    pdfPath: "/cdn/images/cervino ceramix case study.pdf",
  ...
  },
  {
    ...
    logoSrc: "/cdn/images/brandslogo/Bergamot.svg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/begarmot.png",
    websiteUrl: "https://bergamotbeaute.com/",
    pdfPath: "/cdn/images/Bergamot case study.pdf",
  ...
  },
  {
    ...
    logoSrc: "/cdn/images/brandslogo/ajp.svg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/ajp.png",
    websiteUrl: "https://agprojects.otherlogicbeta.com/",
    pdfPath: "/cdn/images/AGPCaseStudy.pdf",
    companyName: "XYZ Startup",
  },
  {
    title: "Case Study: App Development for XYZ Startup",
    ...
    logoSrc: "/cdn/images/iowit.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/iowit case study.png",
    websiteUrl: "https://iowit.com/",
    pdfPath: "/cdn/images/iowit case study.pdf",
    companyName: "XYZ Startup",
  },
    {
    ...
    logoSrc: "/cdn/images/la.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/la osteria case study.png",
    websiteUrl: "https://laosteria.in/",
    pdfPath: "/cdn/images/la osteria case study.pdf",
    companyName: "XYZ Startup",
  },
   {
    ...
    logoSrc: "/cdn/images/sre.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/Sre  india realty case study.png",
    websiteUrl: "https://sreindiarealty.com/",
    pdfPath: "/cdn/images/Sre india realty case study.pdf",
    companyName: "XYZ Startup",
  },
    ...
    logoSrc: "/cdn/images/brandslogo/peace.svg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/peace.png",
    websiteUrl: "https://peaceofmind.tv/",
    pdfPath: "/cdn/images/peace of mind-case study.pdf",
    companyName: "XYZ Startup",
  },
       {
    ...
    logoSrc: "/cdn/images/xrd.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/XRD Nano Case Study.png",
    websiteUrl: "https://www.xrdnano.com/",
    pdfPath: "/cdn/images/XRD Nano case study.pdf",
    companyName: "XYZ Startup",
  },
  {
    ...
    logoSrc: "/cdn/images/medklare.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/cdn/images/medklair portfolio.png",
    websiteUrl: "https://medklaire.com/",
    pdfPath: "/cdn/images/medklair case study.pdf",
    companyName: "XYZ Startup",
  },
];
