...
const DigitalMarketingPage = () => {
  ...
  return (
    <>
      <Head>
        <title>#1 Best Digital Marketing Services - DevNexus Solutions</title>
        <meta
          name="description"
          content="Get the best digital marketing services with DevNexus Solutions to grow your online presence, drive organic traffic, increase ROI. Get a free quote now."
        />
        <link
          rel="canonical"
          href="https://devnexussolutions.com/digital-marketing-services"
        />
        <script
