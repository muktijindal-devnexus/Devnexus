...
const ManagementData = [
  ...
  },
  {
    ...
    role: 'Frontend',
    experience: '5+ years',
    skills:   ['ChatBot', 'Data Enigneering', 'Predictive Analysis', 'Machine Learning'],
     imgUrl: 'images/team/avatar.svg',
  },
...
/>
   <DeveloperCarousel developers={devData} title="Backend Developers" cardsToShow={3}  multiSkillFilter={['Nodejs', 'Express js', 'Nest js', 'Python']} />
   <DeveloperCarousel developers={CMSData} title="CMS Developers" cardsToShow={3} multiSkillFilter={['Wordpress', 'Shopify', 'Webflow', 'Woo Commerce']} />
   <DeveloperCarousel developers={DesignerData} title="Web Designing" cardsToShow={3} multiSkillFilter={['Abobe', 'Figma', 'Photoshop', 'Illustrator']} />
   <DeveloperCarousel developers={ManagementData} title="Database" cardsToShow={3} multiSkillFilter={['MySQL', 'Firebase', 'MongoDB', 'Posgre SQL']} />
   <DeveloperCarousel developers={ManagementData} title="Ecommerce" cardsToShow={3} multiSkillFilter={['Shopify', 'WooCommerce', 'WPCommerce']} />
   <DeveloperCarousel developers={ManagementData} title="Blockchain" cardsToShow={3}multiSkillFilter={['De-Fi', 'Smart Contracts', 'Public Chain', 'Private Chain']} />
   <DeveloperCarousel developers={ManagementData} title=" Artificial Intelligence" cardsToShow={3} multiSkillFilter={['ChatBot', 'Data Enigneering', 'Predictive Analysis', 'Machine Learning']}/>

   <DeveloperCarousel developers={ManagementData} title="Javascript Developer" cardsToShow={3} multiSkillFilter={['React js', 'Next js', 'Angular js', 'Vue js' , 'Typescript']}/>
