...
const caseStudies = [
  {
    ...
    logoSrc: "/images/cervinologo.svg",
    imageIcons: ["/brick-icon.png", "/code-icon.png"],
    mainImage: "/images/cervinoportfolio.png",
  ...
  },
  {
    ...
    logoSrc: "/images/iowit.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/images/iowit case study.png",
    ...
    logoSrc: "/images/la.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/images/la osteria case study.png",
  ...
  },
   {
    ...
    logoSrc: "/images/sre.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/images/Sre  india realty case study.png",
    ...
    logoSrc: "/images/xrd.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/images/XRD Nano Case Study.png",
  ...
  },
  {
    ...
    logoSrc: "/images/medklare.jpeg",
    imageIcons: ["/app-icon.png", "/design-icon.png"],
    mainImage: "/images/medklair portfolio.png",
