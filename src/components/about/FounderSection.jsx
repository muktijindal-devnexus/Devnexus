      ...
      <div className="flex flex-col md:flex-row justify-center gap-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 w-full md:w-[350px]">
          ...
          <p className="text-sm text-[#4C4C4C] text-left">
            ...
            digital growth expertise in SEO, brand positioning, and performance
            marketing. He oversees marketing operations and business
            development. Ankit is driven by a mission to help startups and
            businesses thrive in competitive digital landscapes through smart
            marketing and data-backed strategies.
          </p>
        </div>
